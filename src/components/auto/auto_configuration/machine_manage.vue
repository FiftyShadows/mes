  ...
  <div class="machine">
    ...
    <el-dialog title="新 增" :visible.sync="dialogVisibleSingleAdd" width="50%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="AddMachine('form')">确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修 改" :visible.sync="dialogVisibleSave" width="50%">
      <el-form :model="form1" :rules="rules" ref="form1" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="锭数" :label-width="formLabelWidth" prop="spindleNum" required>
          <el-input-number v-model="form1.spindleNum" :min="1" label="输入锭数..." @change="setSpindleSeq1" style="float: left;"></el-input-number>
        </el-form-item>
        <el-form-item label="人工落筒锭位顺序" :label-width="formLabelWidth" prop="spindleSeq" required>
          <el-tag title="" type="info" v-model="form1.spindleSeq" v-for="(item,index) in form1.spindleSeq" :key="index" :closable="false" style="float: left; width: 60%; text-align: left; margin-bottom: 5px;">
            ...
            <div style="float: right;">
              ...
              <el-button icon="el-icon-upload2 icon" size="mini" type="primary" v-if="form1.spindleSeq.indexOf(item) != 0" @click="saveUp(index)" circle></el-button>
              <el-button type="danger" icon="el-icon-download icon" size="mini" v-if="form1.spindleSeq.indexOf(item) != form1.spindleNum-1" @click="saveDown(index)" circle></el-button>
            </div>
          </el-tag>
        </el-form-item>
      </el-form>
