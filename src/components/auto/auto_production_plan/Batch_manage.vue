    ...
    <el-dialog title="新 增" :visible.sync="dialogVisibleAdd" width="40%">
      <el-form :model="form">
        ...
        <el-form-item label="批号" :label-width="formLabelWidth" prop="batchNo">
          <el-input v-model="form.batchNo" auto-complete="off" style="float: left; width: 200px;" required></el-input>
        </el-form-item>
        <el-form-item label="规格" :label-width="formLabelWidth" prop="spec">
          <el-input v-model="form.spec" auto-complete="off" style="float: left; width: 200px;" required></el-input>
        </el-form-item>
        <el-form-item label="锭重(kg)" :label-width="formLabelWidth" prop="silkWeight">
          <el-input-number v-model="form.silkWeight" :min="0" label="锭重(kg)" style="float: left;"></el-input-number>( kg )
        </el-form-item>
        <el-form-item label="中间值" :label-width="formLabelWidth" prop="centralValue" >
          <el-input-number v-model="form.centralValue" :min="0" label="中间值" style="float: left;"></el-input-number>
        </el-form-item>
        <el-form-item label="孔数" :label-width="formLabelWidth" prop="holeNum">
          <el-input-number v-model="form.holeNum" :min="0" label="孔数" style="float: left;"></el-input-number>
        </el-form-item>
        <el-form-item label="纸管颜色" :label-width="formLabelWidth" prop="tubeColor">
          <el-input v-model="form.tubeColor" auto-complete="off" style="float: left; width: 200px;" required></el-input>
        </el-form-item>
        <el-form-item label="备注" :label-width="formLabelWidth" prop="note">
          <el-input v-model="form.note" type="textarea" autosize auto-complete="off" required></el-input>
        </el-form-item>
      </el-form>
